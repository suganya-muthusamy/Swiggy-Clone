  ...
  return (
    <div className="header">
      <div className="logo-container">
        <img
          className="logo"
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSiMNKzbp-1v4ws4nU_NMCmwSQwxCBeDJsJsg&usqp=CAU"
          alt="logo"
        />
      </div>
  ...
  return (
    <div className="restaurant-card" >
      ...
      <div className="restaurant-info">
        ...
        <div className="ratingTime"><h3 className="rating">*{resData.data.avgRating}</h3>
        <h4>{resData.data.deliveryTime} Minutes</h4></div>
        <h5 style={resData.data.veg?veg:nonVeg}>{resData.data.veg?"Veg":"Non-veg"}</h5>
      </div>
    </div>
  );
};
